...
| **token-savior** — MCP server (github.com/mibayy/token-savior) providing cross-session code | `docker pull ghcr.io/jasonkoopmans/token-savior` | [usage →](token-savior/README.md) |
<!-- catalog:end -->
